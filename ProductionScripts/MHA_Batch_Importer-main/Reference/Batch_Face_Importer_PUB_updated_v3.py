...
class MetaHumanHelper:
    ...
    MHID_MAPPING = {
        ...
        # Update Shell/Deborah/Clara mappings
        ...
        'shell': f'{METAHUMAN_BASE_PATH}/Shell/MHID_Deborah.MHID_Deborah',  # Default to Deborah
        'deborah': f'{METAHUMAN_BASE_PATH}/Shell/MHID_Deborah.MHID_Deborah',
        'debbie': f'{METAHUMAN_BASE_PATH}/Shell/MHID_Deborah.MHID_Deborah',
        'clara': f'{METAHUMAN_BASE_PATH}/Shell/MHID_Clara.MHID_Clara',
    ...
    SKELETAL_MESH_MAPPING = {
        ...
        'ricardo': f'{METAHUMAN_BASE_PATH}/Doctor/SK_MHID_Ricardo.SK_MHID_Ricardo',
        'robert': f'{METAHUMAN_BASE_PATH}/ParoleOfficer/SK_MHID_Robert.SK_MHID_Robert',
        'therese': f'{METAHUMAN_BASE_PATH}/Sonia/SK_MHID_Therese.SK_MHID_Therese',
        'clara': f'{METAHUMAN_BASE_PATH}/Shell/SK_MHID_Clara.SK_MHID_Clara',

        # Character mappings
        'skeezer': f'{METAHUMAN_BASE_PATH}/Skeezer/SK_MHID_Michael.SK_MHID_Michael',
        'doctor': f'{METAHUMAN_BASE_PATH}/Doctor/SK_MHID_Ricardo.SK_MHID_Ricardo',
        'paroleofficer': f'{METAHUMAN_BASE_PATH}/ParoleOfficer/SK_MHID_Robert.SK_MHID_Robert',
        'sonia': f'{METAHUMAN_BASE_PATH}/Sonia/SK_MHID_Therese.SK_MHID_Therese',
        'shell': f'{METAHUMAN_BASE_PATH}/Shell/SK_MHID_Deborah.SK_MHID_Deborah',
        ...
        'shell': f'{METAHUMAN_BASE_PATH}/Shell/SK_MHID_Deborah.SK_MHID_Deborah',  # Default to Deborah
        'deborah': f'{METAHUMAN_BASE_PATH}/Shell/SK_MHID_Deborah.SK_MHID_Deborah',
        'debbie': f'{METAHUMAN_BASE_PATH}/Shell/SK_MHID_Deborah.SK_MHID_Deborah',
        'clara': f'{METAHUMAN_BASE_PATH}/Shell/SK_MHID_Clara.SK_MHID_Clara',
